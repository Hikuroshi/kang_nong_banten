...
<div class="d-none d-sm-block">
    ...
    <div class="container position-relative">
        <div class="card p-3 position-absolute" style="top: 30%; transform: translateY(-50%);">
            <div class="card-body">
                <h2 class="card-title fw-bold">Tentang</h2>
