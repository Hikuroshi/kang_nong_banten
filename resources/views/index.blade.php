...
<div class="container mt-4">
    ...
    <h3 class="text-center fw-bold">
        Kami Paguyuban Kang Nong Provinsi Banten <br> di bawah binaan Dinas Pariwisata Provinsi Banten.
    </h3>
    
</div>
<main class="py-5">
    <div class="bg-gold my-5">
        <div class="container">
            <div class="row g-0">
                <div class="col-12">
                    <div class="card border-0 bg-gold rounded-5">
                        <div class="row m-5 align-items-center">
                            ...
                            <div class="col-md-7 col-lg-8 py-5 py-md-0 text-white">
                                ...
                                <p class="card-text">Rabu, 28 Oktober 2020 Kang Anggara dan Nong Verani telah menghadiri acara yang di selenggarakan oleh KNPI, dalam rangka memperingati Hari Sumpah Pemuda yang bertempat di KNPI Banten.</p>        
                            </div>
                        </div>
                    </div>
                </div>
